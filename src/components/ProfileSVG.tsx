  ...
  return `
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(600, 70)">
        ...
        ` : `
          <g transform="translate(-40, -40)">
            ...
            <text x="40" y="48" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="28" font-weight="bold" fill="${t.text}" text-anchor="middle">
        ...
        ${name ? `
          <text y="70" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="36" font-weight="bold" fill="${t.text}" text-anchor="middle">
            ${name}
          </text>
        ` : ''}
        ...
        <g transform="translate(-${(username.length * 11 + 30) / 2}, ${name ? '100' : '80'})" opacity="0.8">
          ...
          <text x="25" y="14" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="20" fill="${t.textMuted}" text-anchor="start">
            @${username}
          </text>
        </g>
      </g>
      ...
      <g transform="translate(600, 585)">
        <text font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="20" font-weight="bold" fill="${t.text}" text-anchor="middle" opacity="0.8">
          <tspan font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" fill="#ff9d00">🔥</tspan> GitHub Streak
        </text>
        <text y="24" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="14" fill="${t.textMuted}" text-anchor="middle" opacity="0.8">
