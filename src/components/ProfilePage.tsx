      ...
      <html lang="en">
        <head>
          ...
          <style dangerouslySetInnerHTML={{
            __html: `
          .avatar,h1{background:var(--accent-gradient)}.header,.links,.meta,.meta-item,.username{display:flex}.cta-btn,.footer a,.link-btn,.pinned-card{text-decoration:none}body{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;background-color:{};color:var(--text);line-height:1.6;margin:0;padding:0;min-height:100vh}.container{width:100%;max-width:800px;margin:0 auto;padding:3rem 1.5rem}.header{flex-direction:column;align-items:center;text-align:center;margin-bottom:2.5rem;animation:.8s ease-out fadeUp}.avatar{width:100px;height:100px;border-radius:50%;border:4px solid rgba(255,255,255,.1);padding:4px;margin-bottom:1.5rem;box-shadow:0 0 30px rgba(168,85,247,.4)}.link-btn,.pinned-card,.preview-container,.stat-card{background:var(--card-bg);backdrop-filter:blur(10px)}.avatar img{width:100%;height:100%;border-radius:50%;object-fit:cover;background:var(--bg)}h1{font-size:2.2rem;font-weight:800;margin:0 0 .5rem;letter-spacing:-.05em;-webkit-background-clip:text;-webkit-text-fill-color:transparent}.username{font-size:1.1rem;color:var(--muted);margin-bottom:1.2rem;font-weight:500;align-items:center;gap:.5rem}.bio{font-size:1rem;max-width:600px;color:var(--text);margin-bottom:1.5rem}.meta{gap:1.5rem;flex-wrap:wrap;justify-content:center;color:var(--muted);font-size:.95rem;margin-bottom:2rem}.meta-item{align-items:center;gap:.4rem}.meta-icon{opacity:.7}.links{gap:1rem;flex-wrap:wrap;justify-content:center;margin-bottom:3rem}.link-btn{display:inline-flex;align-items:center;gap:.5rem;padding:.6rem 1.2rem;border-radius:99px;border:1px solid var(--border);color:var(--text);font-weight:500;font-size:.9rem;transition:.2s}.pinned-section h2,.stat-value{font-size:1.5rem;font-weight:700}.link-btn:hover{background:rgba(255,255,255,.1);transform:translateY(-2px);border-color:rgba(255,255,255,.3)}.stats-grid{display:flex;justify-content:center;gap:1rem;margin-bottom:2rem;animation:1s ease-out fadeUp;flex-wrap:wrap}.stat-card{border:1px solid var(--border);border-radius:12px;padding:.75rem 1.5rem;text-align:center;transition:transform .3s,border-color .3s;flex:1;min-width:120px;max-width:200px}.stat-card:hover{transform:translateY(-2px);border-color:rgba(255,255,255,.2)}.stat-value{margin-bottom:.1rem;color:var(--text)}.stat-label{font-size:.7rem;color:var(--muted);text-transform:uppercase;letter-spacing:.05em;font-weight:600}.pinned-section{margin-bottom:3rem;animation:1.1s ease-out fadeUp}.pinned-section h2{margin-bottom:1.5rem;text-align:center}.pinned-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1rem}.pinned-card,.pinned-name{display:flex;color:var(--text)}.pinned-card{border:1px solid var(--border);border-radius:12px;padding:1.25rem;text-align:left;transition:transform .2s,border-color .2s;flex-direction:column}.pinned-card:hover{transform:translateY(-3px);border-color:rgba(255,255,255,.2)}.pinned-name{font-weight:600;font-size:1.1rem;margin-bottom:.5rem;align-items:center;gap:.5rem}.pinned-desc{font-size:.85rem;color:var(--muted);margin-bottom:1rem;line-height:1.5;flex-grow:1}.pinned-meta,.pinned-meta-item{display:flex;align-items:center}.pinned-meta{gap:1rem;font-size:.75rem;color:var(--muted)}.pinned-meta-item{gap:.3rem}.lang-dot{width:10px;height:10px;border-radius:50%;display:inline-block}.streak-section{animation:1.2s ease-out fadeUp}.streak-section h2{font-size:1.8rem;margin-bottom:1.5rem;font-weight:700;text-align:center}.preview-container{border:1px solid var(--border);border-radius:20px;padding:0;margin-bottom:3rem;overflow:hidden;box-shadow:0 20px 40px rgba(0,0,0,.4);transition:transform .3s}.preview-container:hover{transform:scale(1.01)}.preview-img{width:100%;height:auto;display:block}.cta-section{text-align:center;margin-top:4rem;padding-top:3rem;border-top:1px solid var(--border)}.cta-btn{display:inline-flex;align-items:center;justify-content:center;padding:1rem 2rem;background:var(--text);color:var(--bg);border:none;border-radius:12px;cursor:pointer;font-weight:700;font-size:1.1rem;transition:.2s;box-shadow:0 4px 15px rgba(255,255,255,.2)}.cta-btn:hover{background:#e5e5e5;transform:translateY(-2px);box-shadow:0 8px 25px rgba(255,255,255,.3)}.footer{margin-top:3rem;font-size:.9rem;color:var(--muted);text-align:center}.footer a{color:var(--text);font-weight:500}.footer a:hover{text-decoration:underline}@keyframes fadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@media (max-width:768px){h1{font-size:1.8rem}.container{padding:1.5rem 1rem}.avatar{width:80px;height:80px}}
          `}} />
        </head>
        <body>
          <div class="container">
